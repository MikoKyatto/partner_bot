...
**Telegram-бот для реферальной программы Lethai Concierge!**  
Выдача уникальных реферальных ссылок, создание QR-кодов, интеграция с Google Sheets для учёта балансов и админ-панель с процессом одобрения пользователей.
...
- 📱 **QR-коды**: Генерация QR-кодов с брендингом Lethai 
